...
use App\Models\Table\DocumentTagTable;
use App\Service\AppService;
use App\Service\AppServiceInterface;
use Illuminate\Database\Eloquent\Model;
use Illuminate\Support\Str;

class DocumentTagService extends AppService implements AppServiceInterface
{

    public function __construct(DocumentTagTable $model)
    {
